...
let Calls = {
  ...
  getJokes(dtoIn) {
    let commandUri = Calls.getCommandUri("jokes/list");
    return Calls.call("get", commandUri, dtoIn);
  },

  getOneJoke(dtoIn) {
    let commandUri = Calls.getCommandUri("jokes/get");
    return Calls.call("get", commandUri, dtoIn);
  },

  createJoke(dtoIn) {
    let commandUri = Calls.getCommandUri("jokes/create");
    return Calls.call("post", commandUri, dtoIn);
  },

  updateJoke(dtoIn) {
    let commandUri = Calls.getCommandUri("jokes/update");
    return Calls.call("post", commandUri, dtoIn);
  },
